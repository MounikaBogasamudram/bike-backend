...
public class BikeController {
	...
	public Bike findById(@RequestParam int id) {
		
		
		 Bike doctor =doctorRepo.findById(id).get();
	...
	public String addProduct(@RequestParam ("dietFile") MultipartFile myFile,
		...
		try {
			Bike prdImage = new Bike(name,degree,spl,exp,address,phone,
	...
	public List<Bike> deleteDoctor(@RequestParam int id){
	...
	public List<Bike> getAllProducts(){
		...
		List<Bike> drList = new ArrayList<Bike>();
		
		List<Bike> resDrList = doctorRepo.findAll();
		Bike doctor = null;
